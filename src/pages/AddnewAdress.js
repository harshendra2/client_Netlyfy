...
import {addcustomepageadress} from "../services/Apis"
import * as Yup from 'yup';

function CustomepageAddress(){
    ...
    const [inputdata, setInputdata] = useState({
      ...
      const submit = async (e) => {
        ...
        try {
          ...
          const response = await addcustomepageadress({ id, ...inputdata });
...
export default CustomepageAddress;